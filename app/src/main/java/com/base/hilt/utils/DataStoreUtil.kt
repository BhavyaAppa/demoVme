...
import com.base.hilt.utils.DataStoreUtil.PreferencesKeys.PREF_IS_USER_LOGGED_IN
...
interface PreferenceStorage {
    ...
    suspend fun userLoggedIn(value: Boolean)
    val isUserLoggedIn: Flow<Boolean>

    suspend fun setSecuredData(value: String)
    fun getSecuredData(): Flow<String?>
 ...
 class DataStoreUtil @Inject constructor(
   private val dataStore: DataStore<Preferences>,
    ...
    object PreferencesKeys {
        val PREF_IS_USER_LOGGED_IN = booleanPreferencesKey("pref_is_logged_in")
   ...
   override fun getSecuredData() = dataStore.data.catchAndHandleError()
    ...
    override suspend fun userLoggedIn(value: Boolean) {
        dataStore.edit {
            it[PREF_IS_USER_LOGGED_IN] = value
        }
    }

    override val isUserLoggedIn = dataStore.data.map {
        it[PREF_IS_USER_LOGGED_IN] ?: false
    }



    @OptIn(ExperimentalSerializationApi::class)
    override suspend fun setSecuredData(value: String) {
    ...
    */
    ...
    suspend  fun < T : Any> retrieveValue(
        key: String,
        clazz: KClass<T>
    ): Flow<T?> {
