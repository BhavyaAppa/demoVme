...
*/
    ...
    private fun handleGraphNavigation() {
        ...
        navController.let {
            ...
            if (getIntValue<Int>(Constants.KEY_START_DESTINATION) != -1) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_home, R.id.navigation_data_store
            )
        )
...
//        dataStoreUtil= DataStoreUtil(this.applicationContext, SecurityUtil())
        /**
